...
class MovieFavoriteTab extends StatelessWidget {
  final List<Movie> items;
  final bool isLoading;
  final bool isFetchingMore;
  final ScrollController scrollController;

  const MovieFavoriteTab({
    required this.items,
        ...
        child: Column(
          ...
          children: [
            ...
            PrimaryIconButton(
              ...
              icon: Icons.refresh,
              onPressed: () async {
                await context.read<FavoriteProvider>().fetchMovieFavorite(
                  initialLoad: true,
                  reset: true,
                );
              },
